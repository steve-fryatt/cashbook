...
SRCZIPFILE := cashbook$(RELEASE)src.zip
...
CCFLAGS := -mlibscl -mhard-float -static -mthrowback -Wall -O2 -DDEBUG -D'BUILD_VERSION="$(VERSION)"' -D'BUILD_DATE="$(BUILD_DATE)"' -fno-strict-aliasing -mpoke-function-name
ZIPFLAGS := -x "*/.svn/*" -r -, -9
...
OBJS = account.o accview.o amenu.o analysis.o budget.o calculation.o caret.o choices.o    \
       ...
       report.o saveas.o sorder.o templates.o transact.o window.o
