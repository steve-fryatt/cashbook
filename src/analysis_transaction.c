...
static struct dialogue_icon analysis_transaction_icon_list[] = {
	...
	{DIALOGUE_ICON_SHADE_TARGET,							ANALYSIS_TRANS_BUDGET,		DIALOGUE_NO_ICON},
	{DIALOGUE_ICON_SHADE_ON,							ANALYSIS_TRANS_DATEFROMTXT,	ANALYSIS_TRANS_BUDGET},
	{DIALOGUE_ICON_SHADE_ON | DIALOGUE_ICON_REFRESH,				ANALYSIS_TRANS_DATEFROM,	ANALYSIS_TRANS_BUDGET},
	{DIALOGUE_ICON_SHADE_ON,							ANALYSIS_TRANS_DATETOTXT,	ANALYSIS_TRANS_BUDGET},
	{DIALOGUE_ICON_SHADE_ON | DIALOGUE_ICON_REFRESH,				ANALYSIS_TRANS_DATETO,		ANALYSIS_TRANS_BUDGET},

	/* Group Period. */

	{DIALOGUE_ICON_SHADE_TARGET,							ANALYSIS_TRANS_GROUP,		DIALOGUE_NO_ICON},
	{DIALOGUE_ICON_SHADE_OFF | DIALOGUE_ICON_REFRESH,				ANALYSIS_TRANS_PERIOD,		ANALYSIS_TRANS_GROUP},
	{DIALOGUE_ICON_SHADE_OFF,							ANALYSIS_TRANS_PTEXT,		ANALYSIS_TRANS_GROUP},
	{DIALOGUE_ICON_SHADE_OFF,							ANALYSIS_TRANS_LOCK,		ANALYSIS_TRANS_GROUP},
	{DIALOGUE_ICON_SHADE_OFF | DIALOGUE_ICON_RADIO,					ANALYSIS_TRANS_PDAYS,		ANALYSIS_TRANS_GROUP},
	{DIALOGUE_ICON_SHADE_OFF | DIALOGUE_ICON_RADIO,					ANALYSIS_TRANS_PMONTHS,		ANALYSIS_TRANS_GROUP},
	{DIALOGUE_ICON_SHADE_OFF | DIALOGUE_ICON_RADIO,					ANALYSIS_TRANS_PYEARS,		ANALYSIS_TRANS_GROUP},

	/* Account Fields. */

	{DIALOGUE_ICON_ACCOUNT_POPUP | DIALOGUE_ICON_TYPE_FROM | DIALOGUE_ICON_REFRESH,	ANALYSIS_TRANS_FROMSPEC,	DIALOGUE_NO_ICON},
	{DIALOGUE_ICON_ACCOUNT_POPUP | DIALOGUE_ICON_TYPE_FROM,				ANALYSIS_TRANS_FROMSPECPOPUP,	ANALYSIS_TRANS_FROMSPEC},
	{DIALOGUE_ICON_ACCOUNT_POPUP | DIALOGUE_ICON_TYPE_TO | DIALOGUE_ICON_REFRESH,	ANALYSIS_TRANS_TOSPEC,		DIALOGUE_NO_ICON},
	{DIALOGUE_ICON_ACCOUNT_POPUP | DIALOGUE_ICON_TYPE_TO,				ANALYSIS_TRANS_TOSPECPOPUP,	ANALYSIS_TRANS_TOSPEC},

	/* Filter Fields. */

	{DIALOGUE_ICON_REFRESH,								ANALYSIS_TRANS_REFSPEC,		DIALOGUE_NO_ICON},
	{DIALOGUE_ICON_REFRESH,								ANALYSIS_TRANS_DESCSPEC,	DIALOGUE_NO_ICON},
	{DIALOGUE_ICON_REFRESH,								ANALYSIS_TRANS_AMTLOSPEC,	DIALOGUE_NO_ICON},
	{DIALOGUE_ICON_REFRESH,								ANALYSIS_TRANS_AMTHISPEC,	DIALOGUE_NO_ICON},
...
static void analysis_transaction_open_window(void *instance, wimp_pointer *pointer, template_t template, osbool restore)
{
	...
	analysis_dialogue_open(analysis_transaction_dialogue, report, report->parent, pointer, template, &(report->saved), restore);
}
