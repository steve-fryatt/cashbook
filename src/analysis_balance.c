...
static struct dialogue_icon analysis_balance_icon_list[] = {
	{DIALOGUE_ICON_GENERATE,				ANALYSIS_BALANCE_OK,			DIALOGUE_NO_ICON},
	{DIALOGUE_ICON_CANCEL,					ANALYSIS_BALANCE_CANCEL,		DIALOGUE_NO_ICON},
	{DIALOGUE_ICON_DELETE,					ANALYSIS_BALANCE_DELETE,		DIALOGUE_NO_ICON},
	{DIALOGUE_ICON_RENAME,					ANALYSIS_BALANCE_RENAME,		DIALOGUE_NO_ICON},
