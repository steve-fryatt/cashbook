...
static struct dialogue_icon analysis_cashflow_icon_list[] = {
	...
	{DIALOGUE_ICON_DELETE | DIALOGUE_ICON_ACTION,		ANALYSIS_CASHFLOW_DELETE,		DIALOGUE_NO_ICON},
	{DIALOGUE_ICON_RENAME | DIALOGUE_ICON_ACTION,		ANALYSIS_CASHFLOW_RENAME,		DIALOGUE_NO_ICON},
