...
static struct dialogue_icon analysis_cashflow_icon_list[] = {
	{DIALOGUE_ICON_OK,								ANALYSIS_CASHFLOW_OK,			DIALOGUE_NO_ICON},
	{DIALOGUE_ICON_CANCEL,								ANALYSIS_CASHFLOW_CANCEL,		DIALOGUE_NO_ICON},
	{DIALOGUE_ICON_ACTION | DIALOGUE_ICON_ANALYSIS_DELETE,				ANALYSIS_CASHFLOW_DELETE,		DIALOGUE_NO_ICON},
	{DIALOGUE_ICON_ACTION | DIALOGUE_ICON_ANALYSIS_RENAME,				ANALYSIS_CASHFLOW_RENAME,		DIALOGUE_NO_ICON},

	/* Budget Group. */

	{DIALOGUE_ICON_SHADE_TARGET,							ANALYSIS_CASHFLOW_BUDGET,		DIALOGUE_NO_ICON},
	{DIALOGUE_ICON_SHADE_ON,							ANALYSIS_CASHFLOW_DATEFROMTXT,		ANALYSIS_CASHFLOW_BUDGET},
	{DIALOGUE_ICON_SHADE_ON | DIALOGUE_ICON_REFRESH,				ANALYSIS_CASHFLOW_DATEFROM,		ANALYSIS_CASHFLOW_BUDGET},
	{DIALOGUE_ICON_SHADE_ON,							ANALYSIS_CASHFLOW_DATETOTXT,		ANALYSIS_CASHFLOW_BUDGET},
	{DIALOGUE_ICON_SHADE_ON | DIALOGUE_ICON_REFRESH,				ANALYSIS_CASHFLOW_DATETO,		ANALYSIS_CASHFLOW_BUDGET},

	/* Group Period. */

	{DIALOGUE_ICON_SHADE_TARGET,							ANALYSIS_CASHFLOW_GROUP,		DIALOGUE_NO_ICON},
	{DIALOGUE_ICON_SHADE_OFF | DIALOGUE_ICON_REFRESH,				ANALYSIS_CASHFLOW_PERIOD,		ANALYSIS_CASHFLOW_GROUP},
	{DIALOGUE_ICON_SHADE_OFF,							ANALYSIS_CASHFLOW_PTEXT,		ANALYSIS_CASHFLOW_GROUP},
	{DIALOGUE_ICON_SHADE_OFF,							ANALYSIS_CASHFLOW_LOCK,			ANALYSIS_CASHFLOW_GROUP},
	{DIALOGUE_ICON_SHADE_OFF | DIALOGUE_ICON_RADIO,					ANALYSIS_CASHFLOW_PDAYS,		ANALYSIS_CASHFLOW_GROUP},
	{DIALOGUE_ICON_SHADE_OFF | DIALOGUE_ICON_RADIO,					ANALYSIS_CASHFLOW_PMONTHS,		ANALYSIS_CASHFLOW_GROUP},
	{DIALOGUE_ICON_SHADE_OFF | DIALOGUE_ICON_RADIO,					ANALYSIS_CASHFLOW_PYEARS,		ANALYSIS_CASHFLOW_GROUP},
	{DIALOGUE_ICON_SHADE_OFF,							ANALYSIS_CASHFLOW_EMPTY,		ANALYSIS_CASHFLOW_GROUP},

	/* Account Fields. */

	{DIALOGUE_ICON_ACCOUNT_POPUP | DIALOGUE_ICON_TYPE_FULL | DIALOGUE_ICON_REFRESH,	ANALYSIS_CASHFLOW_ACCOUNTS,		DIALOGUE_NO_ICON},
	{DIALOGUE_ICON_ACCOUNT_POPUP | DIALOGUE_ICON_TYPE_FULL,				ANALYSIS_CASHFLOW_ACCOUNTSPOPUP,	ANALYSIS_CASHFLOW_ACCOUNTS},
	{DIALOGUE_ICON_ACCOUNT_POPUP | DIALOGUE_ICON_TYPE_IN | DIALOGUE_ICON_REFRESH,	ANALYSIS_CASHFLOW_INCOMING,		DIALOGUE_NO_ICON},
	{DIALOGUE_ICON_ACCOUNT_POPUP | DIALOGUE_ICON_TYPE_IN,				ANALYSIS_CASHFLOW_INCOMINGPOPUP,	ANALYSIS_CASHFLOW_INCOMING},
	{DIALOGUE_ICON_ACCOUNT_POPUP | DIALOGUE_ICON_TYPE_OUT | DIALOGUE_ICON_REFRESH,	ANALYSIS_CASHFLOW_OUTGOING,		DIALOGUE_NO_ICON},
	{DIALOGUE_ICON_ACCOUNT_POPUP | DIALOGUE_ICON_TYPE_OUT,				ANALYSIS_CASHFLOW_OUTGOINGPOPUP,	ANALYSIS_CASHFLOW_OUTGOING},
