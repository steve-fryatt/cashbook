...
static struct column_map interest_columns[INTEREST_COLUMNS] = {
	{INTEREST_ICON_DATE, wimp_ICON_WINDOW, INTEREST_PANE_DATE, wimp_ICON_WINDOW, SORT_DATE},
	{INTEREST_ICON_RATE, wimp_ICON_WINDOW, INTEREST_PANE_RATE, wimp_ICON_WINDOW, SORT_RATE},
	{INTEREST_ICON_BALANCE, wimp_ICON_WINDOW, INTEREST_PANE_BALANCE, wimp_ICON_WINDOW, SORT_BALANCE},
	{INTEREST_ICON_DESCRIPTION, wimp_ICON_WINDOW, INTEREST_PANE_DESCRIPTION, wimp_ICON_WINDOW, SORT_DESCRIPTION}
};
