...
static struct dialogue_icon analysis_cashflow_icon_list[] = {
	{DIALOGUE_ICON_GENERATE,				ANALYSIS_CASHFLOW_OK,			DIALOGUE_NO_ICON},
	{DIALOGUE_ICON_CANCEL,					ANALYSIS_CASHFLOW_CANCEL,		DIALOGUE_NO_ICON},
	{DIALOGUE_ICON_DELETE,					ANALYSIS_CASHFLOW_DELETE,		DIALOGUE_NO_ICON},
	{DIALOGUE_ICON_RENAME,					ANALYSIS_CASHFLOW_RENAME,		DIALOGUE_NO_ICON},
