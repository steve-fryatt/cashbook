...
static struct dialogue_icon analysis_balance_icon_list[] = {
	...
	{DIALOGUE_ICON_DELETE | DIALOGUE_ICON_ACTION,		ANALYSIS_BALANCE_DELETE,		DIALOGUE_NO_ICON},
	{DIALOGUE_ICON_RENAME | DIALOGUE_ICON_ACTION,		ANALYSIS_BALANCE_RENAME,		DIALOGUE_NO_ICON},
