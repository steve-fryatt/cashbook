...
static struct column_map preset_list_window_columns[PRESET_LIST_WINDOW_COLUMNS] = {
	{PRESET_LIST_WINDOW_KEY, wimp_ICON_WINDOW, PRESET_LIST_WINDOW_PANE_KEY, wimp_ICON_WINDOW, SORT_CHAR},
	{PRESET_LIST_WINDOW_NAME, wimp_ICON_WINDOW, PRESET_LIST_WINDOW_PANE_NAME, wimp_ICON_WINDOW, SORT_NAME},
	{PRESET_LIST_WINDOW_FROM, wimp_ICON_WINDOW, PRESET_LIST_WINDOW_PANE_FROM, wimp_ICON_WINDOW, SORT_FROM},
	{PRESET_LIST_WINDOW_FROM_REC, PRESET_LIST_WINDOW_FROM, PRESET_LIST_WINDOW_PANE_FROM, wimp_ICON_WINDOW, SORT_FROM},
	{PRESET_LIST_WINDOW_FROM_NAME, PRESET_LIST_WINDOW_FROM, PRESET_LIST_WINDOW_PANE_FROM, wimp_ICON_WINDOW, SORT_FROM},
	{PRESET_LIST_WINDOW_TO, wimp_ICON_WINDOW, PRESET_LIST_WINDOW_PANE_TO, wimp_ICON_WINDOW, SORT_TO},
	{PRESET_LIST_WINDOW_TO_REC, PRESET_LIST_WINDOW_TO, PRESET_LIST_WINDOW_PANE_TO, wimp_ICON_WINDOW, SORT_TO},
	{PRESET_LIST_WINDOW_TO_NAME, PRESET_LIST_WINDOW_TO, PRESET_LIST_WINDOW_PANE_TO, wimp_ICON_WINDOW, SORT_TO},
	{PRESET_LIST_WINDOW_AMOUNT, wimp_ICON_WINDOW, PRESET_LIST_WINDOW_PANE_AMOUNT, wimp_ICON_WINDOW, SORT_AMOUNT},
	{PRESET_LIST_WINDOW_DESCRIPTION, wimp_ICON_WINDOW, PRESET_LIST_WINDOW_PANE_DESCRIPTION, wimp_ICON_WINDOW, SORT_DESCRIPTION}
};
...
static void preset_list_window_redraw_handler(int index, struct file_block *file, void *data, void *redraw);
