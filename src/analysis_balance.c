...
static struct dialogue_icon analysis_balance_icon_list[] = {
	{DIALOGUE_ICON_OK,								ANALYSIS_BALANCE_OK,		DIALOGUE_NO_ICON},
	{DIALOGUE_ICON_CANCEL,								ANALYSIS_BALANCE_CANCEL,	DIALOGUE_NO_ICON},
	{DIALOGUE_ICON_ACTION | DIALOGUE_ICON_ANALYSIS_DELETE,				ANALYSIS_BALANCE_DELETE,	DIALOGUE_NO_ICON},
	{DIALOGUE_ICON_ACTION | DIALOGUE_ICON_ANALYSIS_RENAME,				ANALYSIS_BALANCE_RENAME,	DIALOGUE_NO_ICON},

	/* Budget Group. */

	{DIALOGUE_ICON_SHADE_TARGET,							ANALYSIS_BALANCE_BUDGET,	DIALOGUE_NO_ICON},
	{DIALOGUE_ICON_SHADE_ON,							ANALYSIS_BALANCE_DATEFROMTXT,	ANALYSIS_BALANCE_BUDGET},
	{DIALOGUE_ICON_SHADE_ON | DIALOGUE_ICON_REFRESH,				ANALYSIS_BALANCE_DATEFROM,	ANALYSIS_BALANCE_BUDGET},
	{DIALOGUE_ICON_SHADE_ON,							ANALYSIS_BALANCE_DATETOTXT,	ANALYSIS_BALANCE_BUDGET},
	{DIALOGUE_ICON_SHADE_ON | DIALOGUE_ICON_REFRESH,				ANALYSIS_BALANCE_DATETO,	ANALYSIS_BALANCE_BUDGET},

	/* Group Period. */

	{DIALOGUE_ICON_SHADE_TARGET,							ANALYSIS_BALANCE_GROUP,		DIALOGUE_NO_ICON},
	{DIALOGUE_ICON_SHADE_OFF | DIALOGUE_ICON_REFRESH,				ANALYSIS_BALANCE_PERIOD,	ANALYSIS_BALANCE_GROUP},
	{DIALOGUE_ICON_SHADE_OFF,							ANALYSIS_BALANCE_PTEXT,		ANALYSIS_BALANCE_GROUP},
	{DIALOGUE_ICON_SHADE_OFF,							ANALYSIS_BALANCE_LOCK,		ANALYSIS_BALANCE_GROUP},
	{DIALOGUE_ICON_SHADE_OFF | DIALOGUE_ICON_RADIO,					ANALYSIS_BALANCE_PDAYS,		ANALYSIS_BALANCE_GROUP},
	{DIALOGUE_ICON_SHADE_OFF | DIALOGUE_ICON_RADIO,					ANALYSIS_BALANCE_PMONTHS,	ANALYSIS_BALANCE_GROUP},
	{DIALOGUE_ICON_SHADE_OFF | DIALOGUE_ICON_RADIO,					ANALYSIS_BALANCE_PYEARS,	ANALYSIS_BALANCE_GROUP},

	/* Account Fields. */

	{DIALOGUE_ICON_ACCOUNT_POPUP | DIALOGUE_ICON_TYPE_FULL | DIALOGUE_ICON_REFRESH,	ANALYSIS_BALANCE_ACCOUNTS,	DIALOGUE_NO_ICON},
	{DIALOGUE_ICON_ACCOUNT_POPUP | DIALOGUE_ICON_TYPE_FULL,				ANALYSIS_BALANCE_ACCOUNTSPOPUP,	ANALYSIS_BALANCE_ACCOUNTS},
	{DIALOGUE_ICON_ACCOUNT_POPUP | DIALOGUE_ICON_TYPE_IN | DIALOGUE_ICON_REFRESH,	ANALYSIS_BALANCE_INCOMING,	DIALOGUE_NO_ICON},
	{DIALOGUE_ICON_ACCOUNT_POPUP | DIALOGUE_ICON_TYPE_IN,				ANALYSIS_BALANCE_INCOMINGPOPUP,	ANALYSIS_BALANCE_INCOMING},
	{DIALOGUE_ICON_ACCOUNT_POPUP | DIALOGUE_ICON_TYPE_OUT | DIALOGUE_ICON_REFRESH,	ANALYSIS_BALANCE_OUTGOING,	DIALOGUE_NO_ICON},
	{DIALOGUE_ICON_ACCOUNT_POPUP | DIALOGUE_ICON_TYPE_OUT,				ANALYSIS_BALANCE_OUTGOINGPOPUP,	ANALYSIS_BALANCE_OUTGOING},
